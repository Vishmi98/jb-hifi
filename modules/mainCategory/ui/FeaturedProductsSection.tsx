...
import { getProductsByMainCategory } from "@/modules/products/products.service";
...
const FeaturedProductsSection = ({ mainCategoryId }: FeaturedProductsSectionProps) => {
    ...
    useEffect(() => {
        const fetchFeaturedProducts = async () => {
            try {
                ...
                const response = await getProductsByMainCategory(1, 4, mainCategoryId);
