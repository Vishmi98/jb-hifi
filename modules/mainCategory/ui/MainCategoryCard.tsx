...
export const MainCategoryCard: React.FC<MainCategoryCardProps> = ({ category, href }) => {
    // Default fallback if href isn't provided directly
    const targetHref = href || `/collections/${category.categoryInfo?.slug}/${category.mainSlug}`;
