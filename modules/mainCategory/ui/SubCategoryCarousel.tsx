...
import { SubCategoryCard } from '@/modules/subCategory/ui/SubCategoryCard';
...
export default function SubCategoryCarousel({ mainCategoryId }: SubCategoryCarouselProps) {
    ...
    useEffect(() => {
        ...
        const fetchSubCategories = async () => {
            ...
            try {
                ...
                if (isMounted && response.success && response.subCategories) {
