...
import { getProductsByLeafCategory } from "@/modules/products/products.service";
...
const FeaturedProductsSection = ({ leafCategoryId }: FeaturedProductsSectionProps) => {
    ...
    useEffect(() => {
        const fetchFeaturedProducts = async () => {
            try {
                ...
                const response = await getProductsByLeafCategory(1, 4, leafCategoryId);
