...
export default function AskForJbDealBanner() {
    return (
        <section className="w-[95%] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] mx-auto bg-jb-yellow border-1 border-black p-4 sm:p-6 md:px-8 select-none my-6">
            <div className="mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                    <h2 className="jb-crazy text-3xl md:text-4xl text-black uppercase tracking-tight leading-none mb-1 text-center font-bold">
                        SEEN IT<br />CHEAPER?
                    </h2>
                ...
                <div className="relative border-4 border-jb-red px-6 sm:px-10 py-4 sm:py-6 text-center my-2 lg:my-0">
                    <h3 className="jb-crazy text-3xl md:text-4xl text-jb-red uppercase tracking-tight leading-none font-bold">
                        ASK FOR A JB DEAL!
                    </h3>

                    {/* Badge overlapping bottom border */}
                    <div className="jb-callout-yellow absolute text-jb-yellow -bottom-3.5 left-1/2 transform -translate-x-1/2 bg-jb-red font-black text-xs sm:text-sm px-3 py-0.5 uppercase tracking-wider">
                        INSTORE | ONLINE
                    </div>
                </div>
