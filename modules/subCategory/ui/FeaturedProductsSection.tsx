...
import { getProductsBySubCategory } from "@/modules/products/products.service";
...
const FeaturedProductsSection = ({ subCategoryId }: FeaturedProductsSectionProps) => {
    ...
    useEffect(() => {
        const fetchFeaturedProducts = async () => {
            try {
                ...
                const response = await getProductsBySubCategory(1, 4, subCategoryId);
