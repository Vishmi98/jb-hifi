...
import { updateSubCategory } from "../../subCategory.service";
import { getMainCategoryByCategory } from "../../../mainCategory/mainCategory.service";
import { addSubCategoryValidationSchema } from "../../subCategory.utils";
import { SubCategoryDataType, EditSubCategoryModalProps } from "../../subCategory.types";
...
const EditSubCategoryModal: FC<EditSubCategoryModalProps> = ({ isOpen, onClose, initialValues, reloadData }) => {
