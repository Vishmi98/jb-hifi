...
import { EditStoreModalProps, StoreDataType } from "../../store.types";
import { updateStore } from "../../store.service";
import { addStoreValidationSchema } from "../../store.utils";
    ...
    return (
        ...
        >
            <div
                ...
                className="bg-white rounded-lg w-full max-w-xl max-h-[90vh] overflow-hidden flex flex-col mx-3"
            >
                                ...
                                <label className="text-sm font-medium flex flex-col gap-1">
                                    ...
                                    {logo ? (
                                        <Image
                                            ...
                                            className="mt-2"
                                        />
                                    ) : initialValues.logoPath ? (
                                        <Image
                                            src={initialValues.logoPath}
                                            alt="Thumbnail Preview"
                                            width={150}
                                            height={150}
                                            className="mt-2"
