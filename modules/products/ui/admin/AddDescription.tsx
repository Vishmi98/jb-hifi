...
import { AddSpecificationModalProps, DescriptionDataType } from "../../products.types";
import { addDescription } from "../../products.service";
import { addProductDescriptionInitialValues, addProductDescriptionValidationSchema, featureInitialValues } from "../../products.utils";


export const AddDescriptionModal: React.FC<AddSpecificationModalProps> = ({
    isOpen,
    product,
    onClose,
    reloadData,
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            const response = await addDescription(formData);

            if (response?.success) {
                toast.success(response.message || "Description saved successfully!");
                resetForm();
                setTimeout(() => {
                    onClose();
                    reloadData();
                ...
                toast.error(response?.message || "Failed to save description.");
            }
        } catch (error) {
        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center p-4 border-b">
                    <div>
                        <h2 className="font-semibold text-lg">Add Description</h2>
                        {product?.title && (
                ...
                <Formik
                    initialValues={addProductDescriptionInitialValues}
